    ...
    {shoppingCartFromStore.map((cartItem: cartItemModel, index:number)=>(
      ...
      <div className="p-2 mx-3" style={{ width: "100%" }}>
        <div className="d-flex justify-content-between align-items-center">
          <h4 style={{ fontWeight: 300, color:'black' }}>{cartItem.menuItem?.name}</h4>
          <h4 style={{ color:'black' }}>{( cartItem.quantity! * cartItem.menuItem!.price).toFixed(2)}€</h4>
        </div>
        ...
        <div className="d-flex justify-content-between">
          ...
          >
            ...
            <span>
              <b style={{ color:'black' }}>{cartItem.quantity!}</b>
            </span>
            <span style={{ color: "rgba(22,22,22,.7)" }} role="button">
